...
% UNCLEAR: (1.89) on page 39 is printed as row(d_j r_j)_{j=1:n} with last row
% d_n r_n, although D is stated to have size m, so m was expected in both
% places. The scan reads n; left as printed. See page 39.
\begin{equation}
DA \;=\; \mathrm{row}\,(d_jr_j)_{j=1:n} \;=\;
