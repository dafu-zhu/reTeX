...
% UNCLEAR: the weekly paragraph above sets these as $T_{\bfx}$ and
% $\overline{T}_{\bfx}$ with a bold LOWERCASE x, but the monthly paragraph below
% prints $T_X$ and $\overline{T}_X$ with a plain (non-bold) ITALIC CAPITAL X --
% verified at 1600 dpi on PDF page 220 (folio 204). Reproduced as printed; this
% is an author inconsistency, not an OCR artifact. Do not normalise either one.
