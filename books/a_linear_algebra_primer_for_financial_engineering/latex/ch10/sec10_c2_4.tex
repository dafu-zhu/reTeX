...
% Textstyle fractions (as printed) bring this to ~376pt, which fits the 404.5pt
% measure unscaled. \shrinkwrap is kept as a guard only -- it shrinks nothing
% while the display fits. The source keeps all three matrices on one line.
\[
\shrinkwrap{
