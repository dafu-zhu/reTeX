...
\dfrac{A(2:n,1)}{\sqrt{A(1,1)}} & I_{n-1} \end{pmatrix}
\begin{pmatrix} 1 & \bfzero^t \\[0.6em]
\bfzero & A_{n-1} - \dfrac{A(2:n,1)A(1,2:n)}{A(1,1)} \end{pmatrix}
...
0 & I_{n-1} \end{pmatrix} \\
&= \begin{pmatrix} \sqrt{A(1,1)} & \dfrac{A(1,2:n)}{\sqrt{A(1,1)}} \\[0.6em]
0 & A_{n-1} - \dfrac{A(2:n,1)A(1,2:n)}{A(1,1)} \end{pmatrix}.
\end{align*}
...
A(2:n,1) & \dfrac{A(2:n,1)A(1,2:n)}{A(1,1)} + A_{n-1} -
\dfrac{A(2:n,1)A(1,2:n)}{A(1,1)} \end{pmatrix}
\end{aligned}$}
\]
\[
