...
\[
w_{min,cash} \;=\; 1-\mathbf{1}^tw_{min} \;=\; -0.3356.
\]
...
\end{equation}
the asset weights vector in a portfolio with no cash, i.e., with $\mathbf{1}^tw_T = 1$,
...
\[
\bar\mu^tw_T \;=\; \frac{\bar\mu^t\Sigma_R^{-1}\bar\mu}{\mathbf{1}^t\Sigma_R^{-1}\bar\mu},
\]
and therefore
\begin{equation}
\frac{\mathbf{1}^t\Sigma_R^{-1}\bar\mu}{\bar\mu^t\Sigma_R^{-1}\bar\mu} \;=\;
\frac{1}{\bar\mu^tw_T}.
\end{equation}
...
\notag\\
&= (\mu_P-r_f)\frac{\mathbf{1}^t\Sigma_R^{-1}\bar\mu}{\bar\mu^t\Sigma_R^{-1}\bar\mu}
\cdot \frac{1}{\mathbf{1}^t\Sigma_R^{-1}\bar\mu}\Sigma_R^{-1}\bar\mu \notag\\
&= (1-w_{min,cash})\,w_T,
\end{align}
