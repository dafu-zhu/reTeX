...
% UNCLEAR: in (3.42) below, p.115 prints $\sum Q_i$ (subscript) on the first
% line but $\sum Q^i$ (superscript) on the second, and the last line sums over
% $i$ while the summand is indexed by $k$. Both are author inconsistencies,
% reproduced verbatim -- do not normalise the scripts or the bound.
