...
\end{equation}
Note that
% UNCLEAR: p.113 prints the summation index as $i$ while the summand is
% $p_{RN}(k)$ -- an author index mismatch, reproduced verbatim. Do not
% "correct" the bound to $k$.
\[
...
% UNCLEAR: p.114 prints the numerator as $Q^k$ (superscript) even though
% (3.32) defines it as $Q_k$ and the right-hand side here uses $Q_k$.
% Author inconsistency, reproduced verbatim -- do not lower it to $Q_k$.
\begin{equation}
